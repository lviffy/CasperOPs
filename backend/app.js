...
const { globalLimiter, chatLimiter, priceLimiter, txLimiter, agentLimiter, perToolLimiter } = require('./middleware/rateLimiter');
...
app.use('/agents',        agentLimiter, agentRoutes);
