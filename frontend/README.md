...
This is the frontend application for CasperOPs, built with [Next.js](https://nextjs.org).
...
- 🔗 **Blockchain Integration** - Interact with CasperOPs testnet smart contracts
